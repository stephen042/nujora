    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-4">
          <h5><?= APP_NAME ?></h5>
          <p class="text-white-50">Your one-stop shop for all your needs. Quality products at affordable prices.</p>
        </div>
        ...
        <div class="col-md-2 mb-4">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="/customer/terms-of-service.php" class="text-white-50">Terms of service</a></li>
