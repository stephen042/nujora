    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_POST['create_coupon'])) {
            ...
            try {
                ...
                ");
                $stmt->execute([
                    $seller_id, $code, $discount_type, $discount_value, $min_spend, 
                    $expiry_date, $coupon_type, $status, $max_redemptions, $commission
                ]);
...
<head>
    ...
    <title>Seller Dashboard | TrendyMart</title>
    ...
    <style>
        ...
        .status-redeemed { background: #6c757d; color: #fff; }
        .status-pending_payment { background: #fd7e14; color: #fff; }
